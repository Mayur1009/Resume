...
\school{M.Tech Computer Science and Engineering - 7.75/10.00} %
...
\school{B.E Computer Science and Engineering - 9.28/10.00} %
...
\section{\faList}{SKILLS}
	\keyword{Python} \keyword{R} \keyword{C++} \keyword{C} \keyword{LaTex} \keyword{HTML} \keyword{CSS} \keyword{Flutter} %\keyword{JavaScript} \keyword{NodeJS} \keyword{Autodesk Forge}
